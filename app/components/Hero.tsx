...
export default function Hero() {
  ...
  return (
    <>
      <section
        id="inicio"
        className="relative text-white pt-12 pb-28 md:pt-16 md:pb-36 overflow-hidden flex items-center justify-center min-h-[70vh]"
      >
        <div className="max-w-5xl mx-auto px-6 text-center w-full flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full">
            <button
              ...
              className={`${inter.className} group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white text-slate-950 hover:bg-amber-100 px-9 py-4 rounded-full text-xs uppercase tracking-widest font-bold transition-all duration-300 shadow-2xl hover:scale-105 cursor-pointer`}
            >
