...
export default function Contacto() {
  ...
  const handleSolicitarTurno = () => {
    alert("Próximamente se abrirá el sistema de reserva de turnos.");
  };
      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <FadeInSection>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-10 border-b border-slate-200">
            <div>
              <span className="text-xs uppercase tracking-[0.3em] text-amber-800 font-semibold block mb-3">
                Contacto Directo — 03
              </span>
            ...
            <FadeInSection>
              <div className="p-8 bg-slate-50 rounded-3xl border border-slate-200 space-y-6">
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-3 bg-slate-950 text-white text-xs uppercase tracking-widest font-semibold px-6 py-4 rounded-full hover:bg-amber-800 transition-colors duration-300"
                >
